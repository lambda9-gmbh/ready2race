...
data class DataRatingCategoriesExport(
    ...
    companion object {
        fun createExportFile(
            ...
            val json = !WebDAVExportService.serializeDataExportNew(record, mapOf("ratingCategories" to ratingCategories))

            KIO.ok(File(name = getWebDavDataJsonFileName(WebDAVExportType.DB_RATING_CATEGORIES), bytes = json))
        }

        fun importData(data: DataRatingCategoriesExport): App<WebDAVError.WebDAVImportNextError, Unit> = KIO.comprehension {
