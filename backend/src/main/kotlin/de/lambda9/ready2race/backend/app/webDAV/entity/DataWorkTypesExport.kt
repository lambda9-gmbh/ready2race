...
data class DataWorkTypesExport(
    ...
    companion object {
        fun createExportFile(
            ...
            val workTypes = !WorkTypeRepo.allAsJson().orDie()

            val json = !WebDAVExportService.serializeDataExportNew(record, mapOf("workTypes" to workTypes))
        ...
        fun importData(data: DataWorkTypesExport): App<WebDAVError.WebDAVImportNextError, Unit> = KIO.comprehension {
            ...
            !WorkTypeRepo.insertJsonData(data.workTypes.toString()).orDie()
