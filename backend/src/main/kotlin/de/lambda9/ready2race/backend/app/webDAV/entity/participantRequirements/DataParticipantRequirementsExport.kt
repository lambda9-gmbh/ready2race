package de.lambda9.ready2race.backend.app.webDAV.entity.participantRequirements
...
data class DataParticipantRequirementsExport(
    ...
    companion object {
        fun createExportFile(
            ...
            val json = !WebDAVExportService.serializeDataExportNew(record, mapOf("participantRequirements" to participantRequirements))
