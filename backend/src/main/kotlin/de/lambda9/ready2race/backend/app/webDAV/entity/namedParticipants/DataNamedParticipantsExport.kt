...
data class DataNamedParticipantsExport(
    ...
    companion object {
        fun createExportFile(
            ...
            val json = !WebDAVExportService.serializeDataExportNew(record, mapOf("namedParticipants" to namedParticipants))

            KIO.ok(File(name = getWebDavDataJsonFileName(WebDAVExportType.DB_NAMED_PARTICIPANTS), bytes = json))
        }

        fun importData(data: DataNamedParticipantsExport): App<WebDAVError.WebDAVImportNextError, Unit> = KIO.comprehension {
