...
import {AppUserWithQrCodeDto, deleteQrCodeForEvent, getAppUsersWithQrCodeForEvent,} from '../../../api'
    ...
    const columns: GridColDef<AppUserWithQrCodeDto>[] = useMemo(
        () => [
            ...
            },
            {
                ...
                minWidth: 150,
                renderCell: ({row}) =>
                    format(new Date(row.createdAt), t('format.datetime')),
            },
        ],
        [t],
    )
