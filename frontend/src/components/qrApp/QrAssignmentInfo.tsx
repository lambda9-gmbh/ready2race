        ...
        <Paper elevation={2} sx={{ p: 2, width: '100%', bgcolor: 'background.default' }}>
            <Stack spacing={1.5}>
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                    <Person color="action" />
                    <Typography>
                        <strong>{t('common.name')}:</strong> {response.firstname} {response.lastname}
                    </Typography>
                </Stack>
                ...
                {'type' in response && response.type === 'Participant' && 'competitions' in response && response.competitions && response.competitions.length > 0 && (
                    <Stack spacing={1}>
                        <Stack direction="row" spacing={1} alignItems="center">
